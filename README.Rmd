...
This supplementary materials for the manuscript "Life of /p/" uses the R [@R] programming language and the following R libraries [@tidyverse,@knitr,@phytools,@phylotools,@Yu2020-qs,@testthat].
